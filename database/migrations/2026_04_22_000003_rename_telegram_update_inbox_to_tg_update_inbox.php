...
return new class extends Migration {
    ...
    {
        if (Schema::hasTable('telegram_update_inbox') && !Schema::hasTable('tg_update_inbox')) {
            Schema::rename('telegram_update_inbox', 'tg_update_inbox');
        }

        if (Schema::hasTable('tg_update_inbox') && !Schema::hasColumn('tg_update_inbox', 'process_detail')) {
            Schema::table('tg_update_inbox', function (Blueprint $table): void {
                $table->text('process_detail')->nullable()->after('result_code');
            });
        }

        if (Schema::hasTable('tg_update_inbox') && !Schema::hasColumn('tg_update_inbox', 'message_text')) {
            Schema::table('tg_update_inbox', function (Blueprint $table): void {
    ...
    public function down(): void
    {
        ...
        if (Schema::hasTable('tg_update_inbox') && !Schema::hasTable('telegram_update_inbox')) {
            Schema::rename('tg_update_inbox', 'telegram_update_inbox');
        }
    }
};
